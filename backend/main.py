...
async def validation_handler(request: Request, exc: RequestValidationError):
    # Strip 'input' to keep logs compact AND to avoid TypeError when the body
    # is bytes (e.g. wrong Content-Type) — bytes are not JSON-serializable.
    ...
    return JSONResponse(status_code=422, content={"detail": compact})
